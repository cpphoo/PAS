...
# This script contains the commands used to conduct all-way and 5-way nearest centroid evaluation for PAS and self-training
...
# please change the ckpt argument if you want to evaluate other models
num_repetitions=1000

for model in PAS self_training
do
...
###############################################
# Optional: Evaluation for the analyses section
################################################
num_repetitions=1000
...
do
    ...
    do
        ...
        target_directory=$model\_$dataset\_base_reduced/resnet18_seed_1_wd_0.0005
        echo Model Directory: $target_directory
        ...
        target_directory=$model\_$dataset\_base_dropped_a_fifth_parent/resnet18_seed_1_wd_0.0005
        echo Model Directory: $target_directory
