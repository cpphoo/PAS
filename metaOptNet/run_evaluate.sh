...
# this script contains the commands used for 5-way evaluation for MetaOptNet

export CUDA_VISIBLE_DEVICES=0
num_repetitions=10000

for model in metaOptNet
do
    for dataset in inat2019 tieredImageNet cifar100
    do

        target_directory=$model\_$dataset\_5way_10shot/resnet18_seed_1_wd_0.0005

        model_name=checkpoint_60.pkl
