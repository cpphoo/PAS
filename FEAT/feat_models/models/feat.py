...
class FEAT(FewShotModel):
    def __init__(self, args, backbone, feature_dim):
        ...
        # self.temperature = nn.Parameter(torch.ones(1) * args.temperature, requires_grad=True)
        self.slf_attn = MultiHeadAttention(1, feature_dim, feature_dim, feature_dim, dropout=0.5) 

    def evaluate(self, proto, query):
