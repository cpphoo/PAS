...
# This script contains the commands used to train repr-coarse
...
#########################################################
# Training the repr-coarse on various datasests 
#########################################################
...
# CIFAR100-CL
python repr_coarse.py \
--dir repr_coarse_cifar100/resnet18_seed_1_wd_0.0005 \
...
# iNat2019-CL
python repr_coarse.py \
--dir repr_coarse_inat2019/resnet18_seed_1_wd_0.0005 \
...
# tieredImageNet-CL
python repr_coarse.py \
--dir repr_coarse_tieredImageNet/resnet18_seed_1_wd_0.0005 \
